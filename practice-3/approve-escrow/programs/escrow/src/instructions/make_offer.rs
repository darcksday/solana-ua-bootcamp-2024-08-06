...
pub fn approve_offered_tokens_to_delegate(
...
context: &Context<MakeOffer>,
    ...
    let approve_accounts = Approve {
        ...
        delegate: context.accounts.delegate.to_account_info(),
...
pub fn save_offer(context: Context<MakeOffer>, id: u64, token_a_offered_amount:u64, token_b_wanted_amount: u64) -> Result<()> {
